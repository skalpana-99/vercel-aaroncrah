...
export default function Page() {
  return (
    <>
      ...
      <section className="mt-inner max-sm:mb-[100px] lg:mt-lg">
        <div className="container xl:px-0 px-[24px] max-w-[576px] mx-auto">
          <Heading level={1} size="lg" className="text-center mb-sm lg:mb-md">
            <Heading.Text variant="secondaryDark">Get in </Heading.Text>
            <Heading.Text variant="primaryDark">Touch</Heading.Text>
          </Heading>
          <ContactForm />
        </div>
      </section>
