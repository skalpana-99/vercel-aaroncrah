    ...
    return (
        <div className="">
                ...
                <div className="container xl:px-0 w-[90%]">
                    ...
                    <div className="relative max-w-[791px] text-center mx-auto">
                        ...
                        <p className="text-[18px] leading-7 font-light mb-10">
                            ...
                            But his most powerful partner just might be the beautiful but ruthless burglar he’s been pursuing for years.
                        </p>
                        <Button className="px-4 py-[10px] bg-[#EE93F7] text-black font-normal text-lg leading-8 m-auto">
                            Coming March 2025
                        </Button>
                    </div>
                </div>
            ...
            <div className="w-full max-w-full overflow-hidden">
                {/* <Image className="lg:hidden w-full" src='/assets/images/hero-girl-2.png' alt="lady hero" width={508} height={688} /> */}
            </div>
            ...
            <section className="mt-inner lg:mt-lg mb-0 md:mb-[140px] max-sm:pb-[60px]">
                <div className="container xl:px-0 px-[24px]">
                    <Newsletter
                        background="bg-hero-tab-blur"
                        secondaryTitle="Want to learn more about the upcoming release of "
                        primaryTitle="Mask City? "
                        highlightTitle="Sign up below"
                        higlightStyle="!text-light font-light"
                        coverImage="/assets/images/hero-tablet.webp"
                        coverStyle="md:top-[120px]"
                        mobileBg="max-sm:bg-black/20"
                    />
                </div>
            </section>
